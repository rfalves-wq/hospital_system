...
def criar_painel_almoxarifado(apps, schema_editor):
...
def remover_painel_almoxarifado(apps, schema_editor):
    PainelSistema = apps.get_model("accounts", "PainelSistema")
    PerfilAcesso = apps.get_model("accounts", "PerfilAcesso")
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("accounts", "0008_painel_relatorios"),
    ]
    ...
    operations = [
        ...
        migrations.RunPython(criar_painel_almoxarifado, remover_painel_almoxarifado),
    ]
