...
def criar_painel_auditoria(apps, schema_editor):
...
def remover_painel_auditoria(apps, schema_editor):
    PainelSistema = apps.get_model("accounts", "PainelSistema")
    PerfilAcesso = apps.get_model("accounts", "PerfilAcesso")
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("accounts", "0005_alter_painelsistema_codigo"),
    ]
    ...
    operations = [
        ...
        migrations.RunPython(criar_painel_auditoria, remover_painel_auditoria),
    ]
