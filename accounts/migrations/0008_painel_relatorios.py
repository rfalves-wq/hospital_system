...
def criar_painel_relatorios(apps, schema_editor):
...
def remover_painel_relatorios(apps, schema_editor):
    PainelSistema = apps.get_model("accounts", "PainelSistema")
    PerfilAcesso = apps.get_model("accounts", "PerfilAcesso")
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("accounts", "0007_painel_funcionarios"),
    ]
    ...
    operations = [
        ...
        migrations.RunPython(criar_painel_relatorios, remover_painel_relatorios),
    ]
